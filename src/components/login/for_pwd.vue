<template>
    <div>
        ...
        <div class="register_content_update">
            ...
            <p style="margin-left:98px">找回密码</p>
            <el-form :model="formLabelAlign"  hide-required-asterisk    label-width="100px" :rules="rules" ref="formLabelAlign" class="demo-ruleForm">
                ...
                <el-input v-model="formLabelAlign.emila"  maxlength="64" clearable autocomplete="off" placeholder="请输入邮箱号码">
               ...
               <el-form-item>
                    ...
                    <el-link type="primary mary" :underline="false" @click="return_url('login')">取消</el-link>
                </el-form-item>
            </el-form>
            </div>
        </div>
            ...
            if(that.formLabelAlign.emila == "" || that.formLabelAlign.emila == undefined){
                ...
                that.post(that.$store.state.aip+'customerInfo/updatePwdCode',{
                    ...
                    if(res.code == 20000){
                        that.countDown();
                        that.$message({
                            message: '邮箱发送成功，请注意查收！',type: 'success'});
                    }else{
       ...
       pwd_reast(formName){
            ...
            if (valid) {
                ...
                that.put(that.$store.state.aip+'customerInfo/updatePwd',{
                    ...
                    if(res.code == 20000){
                         that.$message({ message: '重置密码成功，即将返回到登录页面',type: 'success' });
                        //跳转到登录页面
                        setTimeout(() => {
